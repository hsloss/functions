...
function multiply(a, b) { //eslint-disable-line
  ...
  let finalstatement = 'The product of ' + a + ' and ' + b + ' is ' + multiplyNumber + '.'
  return [multiplyNumber, finalstatement]
}
...
function sumAndMultiply(a,b,c){
  ...
  let thirdelement = a + ' and ' + b + ' and ' + c + ' sum to ' + secondsum[0] + '.'
  let fourthelement = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' +
  secondmultiply[0] + '.'
  let testarray = [secondsum[0], secondmultiply[0], thirdelement, fourthelement]
  return testarray
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let finalstatement = sumArr[0] + ',' + sumArr[1] +',' + sumArr[2] + ' was passed in as an array of numbers, and ' + secondsum[0] + ' is their sum.'
  console.log(finalstatement)
  return [secondsum[0], finalstatement]
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let finalstatement = 'The numbers ' + multArr[0] + "," + multArr[1] + "," + multArr[2] + ' have a product of 24.'
  console.log(finalstatement)
  return [secondmult[0], finalstatement]
}
